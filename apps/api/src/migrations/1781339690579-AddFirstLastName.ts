...
export class AddFirstLastName1781339690579 implements MigrationInterface {
    name = 'AddFirstLastName1781339690579'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "users" DROP COLUMN "first_name"`);
        await queryRunner.query(`ALTER TABLE "users" ADD "first_name" character varying(100) NOT NULL DEFAULT ''`);
